...
class GaussianMixtureActor(nn.Module):
	...
	def get_log_prob(self, state, action):
		...
		log_p = torch.sum( alpha * logp_tile, dim=1, keepdim=True)

		# print('alpha', alpha.shape)
		# print('logp_tile', logp_tile.shape)
		# print('alpha', alpha[0:5])
		# print('latent_tile', latent_tile[0:5])
		# print('alpha * logp_tile', (alpha * logp_tile).shape)
...
class Critic(nn.Module):
	...
	def forward(self, state, action):
		...
		q1 = self.drop1(self.l1(sa))
		q1 = F.relu(self.layer_norm1(q1))
		q1 = self.drop2(self.l2(q1))
		q1 = F.relu(self.layer_norm2(q1))
		q1 = self.l3(q1)

		q2 = self.drop4(self.l4(sa))
		q2 = F.relu(self.layer_norm4(q2))
		q2 = self.drop5(self.l5(q2))
		q2 = F.relu(self.layer_norm5(q2))
		q2 = self.l6(q2)
		return q1, q2
...
class nodropCritic(nn.Module):
	def __init__(self, state_dim, action_dim):
		super(nodropCritic, self).__init__()
